...
_Update 04/2023:_ We have created a package that implements the ideas presented in this article and
...
```math
  (4000 dot 0.65 dot 8 thin "Bit" + 4000 dot 0.35 dot 64 thin "Bit" + 4000 dot 1 thin "Bit") /
  (4000 dot 64 thin "Bit")
= (0.65 dot 8 + 0.35 dot 64 + 1) / 64 approx 0.45
```

compared to the `float32` compression of
$frac(32 thin "Bit", 64 thin "Bit", style: "horizontal") = 0.5$.
